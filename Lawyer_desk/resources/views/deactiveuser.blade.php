...
<!-- Mirrored from demo.harnishdesign.net/html/oxyy/login-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Apr 2021 23:18:04 GMT -->
<head>
    <meta charset="UTF-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1.0, shrink-to-fit=no">
    <link href="assets/img/lawyerdesk.png" rel="icon"/>
    <title>Welcome to Lawyer Desk</title>
        ...
        <div class="row">
            <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
                <div class="bg-white shadow-md rounded p-4 px-sm-5 mt-4">
                    <div class="logo"><a class="d-flex justify-content-center" title="Oxyy"><img
                                src="assets/img/lawyerdesk.png"></a></div>
                    <hr class="mx-n4 mx-sm-n5">
                    <h3 style="text-align: center;">Welcome To Lawyer Desk</h3>
                    <hr class="mx-n4 mx-sm-n5">
                    <h5 style="text-align: center;">Admin can check your information. After verifying your identity you can login. </h5>
                    <h5 style="text-align: center;">Thanks</h5>
                    <a href="/">
                        <button class="btn btn-primary btn-block my-4" type="button">Home</button>
                    </a>
                </div>
            </div>
        </div>
